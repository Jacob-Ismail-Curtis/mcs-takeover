...
class Robot(Character):
	def __init__(self,robot_name,pos,groups, obstacle_sprites, visible_sprites, attackable_sprites, damage_player, trigger_death_particles, drop_coins, drop_heart):
		...
		# graphics setup
		self.import_graphics(robot_name)
		self.status = 'idle'
		...
		robot_info = robot_data[self.robot_name]
...
# fix steering so that robots can go round walls
	...
	def check_death(self):
		if self.health <= 0:
			...
			coin_number=random.randint(1,8)
